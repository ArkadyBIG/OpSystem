...
int main()
{
    ...
    */
    ...
    // std::cout << std::boolalpha << "f(0) hard failed is " << std::holds_alternative<os::lab1::compfuncs::hard_fail>(os::lab1::compfuncs::trial_f<os::lab1::compfuncs::INT_SUM>(10)) << std::endl;
    auto res = os::lab1::compfuncs::trial_f<os::lab1::compfuncs::INT_SUM>(0);
